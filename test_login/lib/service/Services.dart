...
import '../models/User.dart'; // add the http plugin in pubspec.yaml file.
class Services {
  static const ROOT = 'http://192.168.100.13/Test/UserDB.php';
  static const ROOT1 = 'http://192.168.100.13/Test/Get/User.php';
